<template>
          <v-card class="pa-4 mb-4">
            ...
            <v-row>
              ...
              <v-col cols="12" md="2"><v-select v-model="xp.time_basis" :disabled="xp.mode === 'read_history'" :items="timeBasisItems" item-title="title" item-value="value" :label="t('xp.time_basis')" variant="outlined" density="compact" color="primary" hide-details/></v-col>
              <v-col cols="12" md="2">
  ...
  setup() {
    ...
    const timeBasisItems = computed(() => {
      const base = [
        ...
        { title: store.t("xp.time_basis.date_added"), value: "date_added" },
      ];
      return base;
    });
    onMounted(() => {
